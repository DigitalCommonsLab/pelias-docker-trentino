...
docker tag pelias-importer-trentino-opendata stefcud/pelias-importer-trentino-opendata:latest
docker push stefcud/pelias-importer-trentino-opendata:latest
